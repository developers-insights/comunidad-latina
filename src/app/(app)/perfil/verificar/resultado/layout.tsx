...
/**
 * Resultado de la verificación — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/perfil/verificar`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function ResultadoVerificacionLayout({ children }: { children: ReactNode }) {
  return (
    <>
      <SectionTopBar fallbackHref="/perfil/verificar" />
      {children}
    </>
  );
}
