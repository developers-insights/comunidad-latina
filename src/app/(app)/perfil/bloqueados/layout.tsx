...
/**
 * Perfil › Bloqueados — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/perfil`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function BloqueadosLayout({ children }: { children: ReactNode }) {
  return (
    <>
