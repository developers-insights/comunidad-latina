...
/**
 * Términos de creadores — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/creadores/solicitud`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function TerminosCreadoresLayout({ children }: { children: ReactNode }) {
  return (
    <>
      <SectionTopBar fallbackHref="/creadores/solicitud" />
      {children}
    </>
  );
}
