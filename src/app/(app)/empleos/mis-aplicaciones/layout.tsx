...
/**
 * Mis postulaciones — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/empleos`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function MisAplicacionesLayout({ children }: { children: ReactNode }) {
  return (
    <>
