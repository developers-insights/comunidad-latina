...
/**
 * Formulario: anotarse de voluntario — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/comunidad`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function RegistrarmeVoluntarioLayout({ children }: { children: ReactNode }) {
  return (
    <>
