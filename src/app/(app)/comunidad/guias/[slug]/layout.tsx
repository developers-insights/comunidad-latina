...
/**
 * Una guía — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/comunidad/guias`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function GuiaLayout({ children }: { children: ReactNode }) {
  return (
    <>
      <SectionTopBar fallbackHref="/comunidad/guias" />
      {children}
    </>
  );
}
