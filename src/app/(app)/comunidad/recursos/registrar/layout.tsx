...
/**
 * Formulario: registrar un lugar — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/comunidad/recursos`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function RegistrarRecursoLayout({ children }: { children: ReactNode }) {
  return (
    <>
      <SectionTopBar fallbackHref="/comunidad/recursos" />
      {children}
    </>
  );
}
