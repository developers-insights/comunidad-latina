 ...
 *
 * ── SIN SESIÓN, `sinSesion` y no `needLogin` ────────────────────────────────
 * Esta pantalla VE, no escribe: la justificación de pedir cuenta es la misma
 * que en el tablón (§5.4 — evitar un padrón público de gente vulnerable), no
 * la de "necesitás cuenta para publicar". Por eso usa
 * `COMUNIDAD_COPY.escribirPedido.sinSesion`, igual que `(tablon)/page.tsx`.
 */
