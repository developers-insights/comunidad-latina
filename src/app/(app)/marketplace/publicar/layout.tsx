...
/**
 * Formulario: publicar en Marketplace — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/marketplace`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function PublicarMarketplaceLayout({ children }: { children: ReactNode }) {
  return (
    <>
      <SectionTopBar fallbackHref="/marketplace" />
      {children}
    </>
  );
}
