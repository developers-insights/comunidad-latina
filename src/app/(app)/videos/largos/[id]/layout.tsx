...
/**
 * Un video largo — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/videos/largos`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function VideoLargoLayout({ children }: { children: ReactNode }) {
  return (
    <>
