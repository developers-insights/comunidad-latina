...
/**
 * Cuenta del negocio — la salida de la pantalla.
 *
 ...
 * historial de la app detrás y, si no, cae a `/negocios`.
 * Ver `components/shell/section-top-bar.tsx`.
 */
export default function CuentaNegocioLayout({ children }: { children: ReactNode }) {
  return (
    <>
