export const nav = {
  ...
  search: "Buscar",
  // Pedido del cliente (2026-09-15): "no es 'videos cortos', es 'videos'". Esta
  // clave gobierna la pestaña del bottom nav, el menú de módulos y /buscar —
  // todos leen del diccionario, no del literal.
  videos: "Videos",
  community: "Comunidad",
  messages: "Mensajes",
  profile: "Perfil",
