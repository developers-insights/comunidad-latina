...
const avatarVariants = cva(
  "relative inline-flex shrink-0 items-center justify-center overflow-visible rounded-full bg-brand-tint align-middle font-display font-semibold text-brand-ink select-none",
  {
    variants: {
      size: {
        xs: "size-6 text-[10px]",
